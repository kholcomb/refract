...
describe('Integration: Python AST sidecar', () => {
  ...
  it('should detect known fixture anti-patterns', () => {
    ...
    expect(patterns).toContain('datetime_now_naive')
    expect(patterns).toContain('string_format_sql')
    expect(patterns).toContain('isinstance_chain')
    expect(patterns).toContain('eval_usage')
    expect(patterns).toContain('yaml_unsafe_load')
    expect(patterns).toContain('file_not_closed')
    expect(patterns).toContain('test_no_assertion')
  })
})
...
describe('Integration: TypeScript AST sidecar', () => {
  ...
  it('should detect known fixture anti-patterns', () => {
    ...
    expect(patterns).toContain('eval_usage')
    expect(patterns).toContain('innerhtml_assignment')
    expect(patterns).toContain('promise_no_catch')
    expect(patterns).toContain('console_log_left')
    expect(patterns).toContain('non_null_assertion')
    expect(patterns).toContain('test_no_assertion')
  })
})
